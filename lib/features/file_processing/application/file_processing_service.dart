...
class FileProcessingService {
  ...
  Future<Excel?> _openExcel(String path) => xu.openExcel(path);

  List<String> _headerRow(List<Data?> row) => xu.headerRow(row);

  int? _findColumn(List<String> headers, List<String> acceptable) =>
      xu.findColumn(headers, acceptable);

  String? _cellText(Data? cell) => xu.cellText(cell);

  EmploymentType? _parseEmploymentType(String value) =>
      xu.parseEmploymentType(value);
