...
| Key | Default | Arabic Name | Arabic Description |
|---|---|---|---|
| shift_start_times | [08:00] | أوقات بداية المناوبة | قائمة الأوقات المحتملة لبداية المناوبة. تُستخدم فقط في خوارزمية الكشف التلقائي لتحديد وقت بداية كل موظف — لا تُستخدم مباشرةً عند توليد التقارير |
...
| shift_start_end_tolerance | 60 minutes | هامش البداية والنهاية | الهامش الزمني بالدقائق المسموح به لبصمتي البداية والنهاية |
| shift_inner_tolerance | 30 minutes | هامش النقاط الداخلية | الهامش الزمني بالدقائق المسموح به للبصمات في نقاط التحقق الداخلية |
